...
"""
    ...
    def test_julia_module_scope(self, project_with_multi_scope_julia) -> None:
    ...
    def test_julia_function_scope(self, project_with_multi_scope_julia) -> None:
    ...
    def test_julia_struct_scope(self, project_with_multi_scope_julia) -> None:
        scope = get_enclosing_scope_tool(project_with_multi_scope_julia, "main.jl", 6, 7, "Bar")
        assert_scope_is_class(scope, "struct Bar", "z")

    def test_julia_second_function_scope(self, project_with_multi_scope_julia) -> None:
    ...
    def test_julia_outside_bounds(self, project_with_multi_scope_julia) -> None:
