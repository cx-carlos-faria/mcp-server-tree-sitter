...
"""
    ...
    def test_go_module_scope(self, project_with_multi_scope_go) -> None:
    ...
    def test_go_function_scope(self, project_with_multi_scope_go) -> None:
    ...
    def test_go_type_scope(self, project_with_multi_scope_go) -> None:
    ...
    def test_go_method_scope(self, project_with_multi_scope_go) -> None:
    ...
    def test_go_top_level_function_scope(self, project_with_multi_scope_go) -> None:
    ...
    def test_go_outside_bounds(self, project_with_multi_scope_go) -> None:
