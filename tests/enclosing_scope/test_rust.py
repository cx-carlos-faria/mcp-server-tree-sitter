...
"""
    ...
    def test_rust_module_scope(self, project_with_multi_scope_rust) -> None:
    ...
    def test_rust_function_scope(self, project_with_multi_scope_rust) -> None:
    ...
    def test_rust_outside_bounds(self, project_with_multi_scope_rust) -> None:
