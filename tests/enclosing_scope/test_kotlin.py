...
"""
    ...
    def test_kotlin_module_scope(self, project_with_multi_scope_kotlin: str) -> None:
    ...
    def test_kotlin_function_scope(self, project_with_multi_scope_kotlin: str) -> None:
    ...
    def test_kotlin_class_scope(self, project_with_multi_scope_kotlin: str) -> None:
    ...
    def test_kotlin_method_scope(self, project_with_multi_scope_kotlin: str) -> None:
    ...
    def test_kotlin_second_function_scope(self, project_with_multi_scope_kotlin: str) -> None:
    ...
    def test_kotlin_outside_bounds(self, project_with_multi_scope_kotlin: str) -> None:
        assert_scope_empty(get_enclosing_scope_tool(project_with_multi_scope_kotlin, "main.kt", 99, 0, None))

    def test_kotlin_getter_returns_function_scope(self, project_with_accessors_kotlin: str) -> None:
    ...
    def test_kotlin_setter_returns_function_scope(self, project_with_accessors_kotlin: str) -> None:
