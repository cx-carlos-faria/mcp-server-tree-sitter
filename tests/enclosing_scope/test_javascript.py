...
"""
    ...
    def test_js_position_at_const_returns_module_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_module_level_variable_returns_module_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_foo_returns_function_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_return_inside_foo_returns_function_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_class_returns_class_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_Bar_returns_class_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_in_class_body_not_in_method_returns_class_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_meth_returns_method_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_return_inside_meth_returns_method_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_bar_returns_function_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_at_return_inside_bar_returns_function_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_position_outside_file_boundaries_returns_empty_scope(self, project_with_multi_scope_js) -> None:
    ...
    def test_js_constructor_returns_function_scope(self, project_with_constructor_js) -> None:
