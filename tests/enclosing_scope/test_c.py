...
"""
    ...
    def test_c_module_scope(self, project_with_multi_scope_c) -> None:
    ...
    def test_c_function_scope(self, project_with_multi_scope_c) -> None:
    ...
    def test_c_struct_scope(self, project_with_multi_scope_c) -> None:
        scope = get_enclosing_scope_tool(project_with_multi_scope_c, "main.c", 6, 7, "Bar")
        assert_scope_is_class(scope, "struct Bar", "int z")

    def test_c_second_function_scope(self, project_with_multi_scope_c) -> None:
    ...
    def test_c_outside_bounds(self, project_with_multi_scope_c) -> None:
