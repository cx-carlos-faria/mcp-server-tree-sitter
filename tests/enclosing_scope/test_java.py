...
"""
    ...
    def test_java_module_scope(self, project_with_multi_scope_java) -> None:
    ...
    def test_java_class_scope(self, project_with_multi_scope_java) -> None:
    ...
    def test_java_field_in_class_scope(self, project_with_multi_scope_java) -> None:
    ...
    def test_java_method_scope(self, project_with_multi_scope_java) -> None:
    ...
    def test_java_second_method_scope(self, project_with_multi_scope_java) -> None:
    ...
    def test_java_outside_bounds(self, project_with_multi_scope_java) -> None:
        assert_scope_empty(get_enclosing_scope_tool(project_with_multi_scope_java, "Test.java", 99, 0, None))

    def test_java_constructor_returns_function_scope(self, project_with_constructor_java) -> None:
