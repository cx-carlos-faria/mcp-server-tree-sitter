...
"""
    ...
    def test_swift_module_scope(self, project_with_multi_scope_swift) -> None:
    ...
    def test_swift_function_scope(self, project_with_multi_scope_swift) -> None:
    ...
    def test_swift_class_scope(self, project_with_multi_scope_swift) -> None:
    ...
    def test_swift_method_scope(self, project_with_multi_scope_swift) -> None:
    ...
    def test_swift_second_function_scope(self, project_with_multi_scope_swift) -> None:
    ...
    def test_swift_outside_bounds(self, project_with_multi_scope_swift) -> None:
        assert_scope_empty(get_enclosing_scope_tool(project_with_multi_scope_swift, "main.swift", 99, 0, None))

    def test_swift_getter_returns_function_scope(self, project_with_accessors_swift) -> None:
    ...
    def test_swift_setter_returns_function_scope(self, project_with_accessors_swift) -> None:
