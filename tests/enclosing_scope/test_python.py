...
"""
    ...
    def test_position_at_import_returns_module_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_module_level_assignment_returns_module_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_function_name_returns_function_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_return_inside_foo_returns_function_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_class_keyword_returns_class_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_class_name_returns_class_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_in_class_body_not_in_method_returns_class_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_method_name_returns_method_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_pass_inside_method_returns_method_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_def_inside_class_returns_function_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_second_top_level_function_returns_function_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_at_return_inside_bar_returns_function_scope(self, project_with_multi_scope) -> None:
    ...
    def test_position_outside_file_boundaries_returns_empty_scope(self, project_with_multi_scope) -> None:
