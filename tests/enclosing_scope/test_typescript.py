...
"""
    ...
    def test_ts_module_scope(self, project_with_multi_scope_ts) -> None:
    ...
    def test_ts_function_scope(self, project_with_multi_scope_ts) -> None:
    ...
    def test_ts_class_scope(self, project_with_multi_scope_ts) -> None:
        scope = get_enclosing_scope_tool(project_with_multi_scope_ts, "test.ts", 6, 6, "Bar")
        assert_scope_is_class(scope, "class Bar", "z = 0")

    def test_ts_method_scope(self, project_with_multi_scope_ts) -> None:
    ...
    def test_ts_top_level_function_scope(self, project_with_multi_scope_ts) -> None:
    ...
    def test_ts_outside_bounds(self, project_with_multi_scope_ts) -> None:
        assert_scope_empty(get_enclosing_scope_tool(project_with_multi_scope_ts, "test.ts", 99, 0, None))

    def test_ts_constructor_returns_function_scope(self, project_with_constructor_ts) -> None:
