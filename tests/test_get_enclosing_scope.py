...
class TestFindEnclosingScope:
    ...
    def test_position_inside_function_returns_function_scope(self, python_tree_and_source) -> None:
    ...
    def test_position_on_import_returns_module_scope(self, python_tree_and_source) -> None:
    ...
    def test_position_in_class_body_not_in_method_returns_class_scope(self, python_tree_and_source) -> None:
...
class TestEnclosingScopeForPath:
    ...
    def test_get_enclosing_scope_for_path_returns_scope_dict(self, project_with_python_file) -> None:
