...
def test_list_project_files_basic(test_project) -> None:
...
def test_list_project_files_with_pattern(test_project) -> None:
...
def test_list_project_files_with_max_depth(test_project) -> None:
...
def test_list_project_files_with_extensions(test_project) -> None:
...
def test_get_file_content_basic(test_project) -> None:
...
def test_get_file_content_empty(test_project) -> None:
...
def test_get_file_content_with_line_limits(test_project) -> None:
...
def test_get_file_content_nonexistent_file(test_project) -> None:
...
def test_get_file_content_outside_project(test_project) -> None:
...
def test_get_file_content_as_bytes(test_project) -> None:
...
def test_get_file_info_basic(test_project) -> None:
...
def test_get_file_info_directory(test_project) -> None:
...
def test_get_file_info_nonexistent_file(test_project) -> None:
...
def test_get_file_info_outside_project(test_project) -> None:
...
def test_count_lines(test_project) -> None:
...
def test_count_lines_empty_file(test_project) -> None:
...
def test_count_lines_large_file(test_project) -> None:
